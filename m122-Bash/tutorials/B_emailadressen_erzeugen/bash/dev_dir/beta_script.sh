...
echo "Please see the attachment for new TBZ email adresses." | mail -s "New TBZ Email Addresses" -A ${DEV_DIR}/backup/YYYY-MM-DD_newMailadr_AP23c_Kampus.tar.gz recipient@example.com
