...
echo Benutzerverwaltung abgeschlossen.

REM Setzen des Hostnamens
wmic computersystem where name="%computername%" call rename name="OfficePC_5"
 
REM Konfigurieren der IP-Adresse, Subnetzmaske und Standard-Gateway
netsh interface ipv4 set address name="Ethernet" static 10.0.6.23 255.255.255.0 10.0.6.1
 
REM Konfigurieren der DNS-Server
netsh interface ipv4 set dns name="Ethernet" static 10.0.6.1
netsh interface ipv4 add dns name="Ethernet" 8.8.8.8 index=2
 
REM Setzen des Arbeitsgruppen-Namens
wmic computersystem where name="%computername%" call joindomainorworkgroup name="arista"
 
REM Neustart des Netzwerkadapters, um Änderungen zu übernehmen
netsh interface set interface name="Ethernet" admin=disabled
netsh interface set interface name="Ethernet" admin=enabled
 
echo Netzwerkkonfiguration abgeschlossen. Bitte starten Sie den Computer neu, um alle Änderungen zu übernehmen.
echo Skript ende
pause